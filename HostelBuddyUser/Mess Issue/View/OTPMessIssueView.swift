...
struct OTPMessIssueView: View {
    
    var complaintbody: MessIssueUserModel
    let numberOfFields: Int
    @State var enterValue: [String]
    @FocusState private var fieldFocus: Int?
    @State var oldValue = ""
    
    init(numberOfFields: Int, complaintbody: MessIssueUserModel) {
    ...
    var body: some View {
        ...
        VStack {
            ...
            Button("Verify") {
                ...
                OTPverifyMessIssueViewModel.verifyOTP(complaintbody: complaintbody, otpString: otpStr)
                print(otpStr)
