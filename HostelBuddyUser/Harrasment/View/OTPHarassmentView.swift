...
struct OTPHarassmentView: View {
    
    var complaintbody: HarassmentUserModel
    let numberOfFields: Int
    @State var enterValue: [String]
    @FocusState private var fieldFocus: Int?
    @State var oldValue = ""
    
    init(numberOfFields: Int, complaintbody: HarassmentUserModel) {
    ...
    var body: some View {
        ...
        VStack {
            ...
            Button("Verify") {
                ...
                OTPverifyHarassmentViewModel.verifyOTP(complaintbody: complaintbody, otpString: otpStr)
                print(otpStr)
